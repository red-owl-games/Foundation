...
namespace RedOwl.Editor
{
    ...
    {
        private static string _namespace = "Project";
        private static string _folder = "Assets/Game/Generated";
        
        [MenuItem(("Red Owl/Generate Code"))]
        public static void Generate() // TODO: Run When Unity Starts up?
        {
            Directory.CreateDirectory(_folder.Replace("Assets", Application.dataPath));
            foreach (var generatorType in TypeCache.GetTypesDerivedFrom<ICodeGenerator>())
            {
                ...
                ((ICodeGenerator)Activator.CreateInstance(generatorType)).Generate(_namespace);
            }
            
            AssetDatabase.Refresh();
            
            Log.Always($"Code Regenerated @ '{_folder}'");
        }
...
//------------------------------------------------------------------------------";
        ...
        {
            string filepath = $"{_folder}/{filename}.cs";
