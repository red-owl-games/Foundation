...
namespace RedOwl.Engine
{
    ...
    public class UILayout : LayoutGroup
    {
        ...
        {
            base.OnEnable();
            _navigation = GetComponent<UINavigation>();
            LayoutRebuilder.ForceRebuildLayoutImmediate(transform as RectTransform);
        }

        public override void CalculateLayoutInputHorizontal()
        {
            // TODO: Grid Layouts - the final row if it doesn't have width item count should center their elements
            ...
            if (_navigation != null) _navigation.Rebuild();
        }
