...
namespace RedOwl.Engine
{
    public sealed class mathExt
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float SqrMagnitude(float2 value)
        {
        ...
        */
        ...
        // Circular Clamp - Clamp between 0/360 but handle boundary wrapping properly
        public static float CClamp(float angle)
        {
